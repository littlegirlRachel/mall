						...
						<ul class="nav navbar-nav">
							...
							<li class="dropdown active">
								...
								<ul class="dropdown-menu multi multi1">
									<div class="row">
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												...
												<li><a href="products1">Bags</a></li>
												<li><a href="products1">Caps & Hats</a></li>
												<li><a href="products1">Hoodies & Sweatshirts</a></li>
										...
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												<h6>Submenu2</h6>
												<li><a href="products1">Jackets & Coats</a></li>
												<li><a href="products1">Jeans</a></li>
												<li><a href="products1">Jewellery</a></li>
												<li><a href="products1">Jumpers & Cardigans</a></li>
												<li><a href="products1">Leather Jackets</a></li>
												<li><a href="products1">Long Sleeve T-Shirts</a></li>
										...
										<div class="col-sm-4">
											<ul class="multi-column-dropdown">
												<h6>Submenu3</h6>
												<li><a href="products1">Shirts</a></li>
												<li><a href="products1">Shoes, Boots & Trainers</a></li>
												<li><a href="products1">Sunglasses</a></li>
												<li><a href="products1">Sweatpants</a></li>
												<li><a href="products1">Swimwear</a></li>
												<li><a href="products1">Trousers & Chinos</a></li>
									...
									<div class="row-top">
										<div class="col-sm-6 row1">
											<a href="products1"><img src="images/me2.jpg" alt="" class="img-responsive"></a>
										</div>
										<div class=" col-sm-6 row2">
											<a href="products1"><img src="images/me3.jpg" alt="" class="img-responsive"></a>
										</div>
										<div class="clearfix"></div>
									</div>
								</ul>
...
<div class="banner-top">
	<div class="container">
		...
		<h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="index">Home</a><label>/</label>Products<label>/</label>Men's</h3>
		<div class="clearfix"> </div>
	</div>
</div>
	<!--content-->
		<div class="product">
			...
			<div class="categories animated wow fadeInUp animated" data-wow-delay=".5s" >
					<h3>Categories</h3>
					<ul class="cate">
						<li><i class="glyphicon glyphicon-menu-right" ></i><a href="products">品牌</a> <span>${requestScope.product.name}</span></li>
						<li><i class="glyphicon glyphicon-menu-right" ></i><a href="products">Man</a> <span>(16)</span></li>
							<ul>
								<li><i class="glyphicon glyphicon-menu-right" ></i><a href="products">品牌：${requestScope.product.brand.name}</a> <span>(2)</span></li>
								<li><i class="glyphicon glyphicon-menu-right" ></i><a href="products">编号：${requestScope.product.pid}</a> <span>(5)</span></li>
				...
				<div class="price animated wow fadeInLeft animated" data-wow-delay=".5s" >
					...
					<div class="col-md-6 price-head1">
                                        <div class="price-top1">
                                            ...
                                            <input type="text"  value="${requestScope.product.price}">
                                        </div>
                                    </div>
			...
			<div class="sellers animated wow fadeInLeft" data-wow-delay=".5s">
					...
					<div class="product-go">
						<div class=" fashion-grid">
									<a href="single"><img class="img-responsive " src="images/pcc2.jpg" alt=""></a>
							...
							<div class="product-go">
						<div class=" fashion-grid">
									<a href="single"><img class="img-responsive " src="images/pcc3.jpg" alt=""></a>
