...
<div class="banner-top">
	<div class="container">
		...
		<h3 class="animated wow fadeInRight" data-wow-delay=".5s"><a href="index">Home</a><label>/</label>Checkout</h3>
		<div class="clearfix"> </div>
	</div>
</div>
<!-- contact -->
 ...
 <table class="table animated wow fadeInLeft" data-wow-delay=".5s">
		  ...
		  <tr class="cross1">
		  <td class="t-data ring-in"><a href="single" class="at-in"><img src="images/pcc2.jpg" class="img-responsive" alt=""></a>
			<div class="sed">
				<h5>Sed ut perspiciatis unde</h5>
			</div>
			<div class="clearfix"> </div>
		  ...
		  <tr class="cross2">
		  <td class="t-data ring-in"><a href="single" class="at-in"><img src="images/pcc1.jpg" class="img-responsive" alt=""></a>
			<div class="sed">
				<h5>Sed ut perspiciatis unde</h5>
			</div>
			<div class="clearfix"> </div>
